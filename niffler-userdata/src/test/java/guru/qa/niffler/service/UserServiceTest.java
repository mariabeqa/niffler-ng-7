...
class UserServiceTest {
  ...
  void init() {
    ...
    secondTestUser.setPhoto(fullPhoto.getBytes(StandardCharsets.UTF_8));
    secondTestUser.setPhotoSmall(new SmallPhoto(100, 100, fullPhoto).bytes());
    ...
    thirdTestUser.setPhoto(fullPhoto.getBytes(StandardCharsets.UTF_8));
    thirdTestUser.setPhotoSmall(new SmallPhoto(100, 100, fullPhoto).bytes());
  }
